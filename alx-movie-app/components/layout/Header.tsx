...
const Header: React.FC = () => {
    return (
        <header className="h-28 flex items-center bg-[#5a6168] px-4 md:px-16 lg:px-44 tex-white">
            <div className="flex items-center justify-between w-full">
                <h2 className="text-xl md:text-4xl font-semibold">Cine<span className="tex-[#E2D609]">Seek</span></h2>
